...
<div class="sort_update">
    ...
    <div class="update">
    	<ul>
    		<!-- Click Last Update-->
        	<?php echo isset($last_update)?'<li>'.$last_update.'</li>' :'' ; ?>
			<!-- End Click Last Update-->
            <?php echo isset($last_update)?'<li>|</li>':'';?>
			<!-- Click Most Active-->
            <?php echo isset($most_active)?'<li>'.$most_active.'</li>' :'' ; ?>
...
<div class="content_status">
	...
	<?php $this->load->view('zhout/zhout_wishlist_product_single') ?>
</div>
